...
WIDGETS_METADATA: Dict[str, Any] = {'system_metric': {'aliases': ['system'], 'implemented': True, 'renderer': 'SystemWidget', 'renderer_module': 'frontend/src/scene/widgets/SystemWidget.tsx', 'renderer_export': 'SystemWidget', 'default_dismiss_policy': 'timed', 'default_auto_dismiss_ms': 5000, 'default_zone': 'top_right', 'supports': {'drag': True, 'resize': True, 'pin': True, 'auto_dismiss': True}, 'description': 'System hardware telemetry (CPU, RAM, GPU, Disk, Network, Battery)'}, 'composed_surface': {'aliases': [], 'implemented': True, 'renderer': 'SurfaceComposer', 'renderer_module': 'frontend/src/composer/SurfaceComposer.tsx', 'renderer_export': 'SurfaceComposer', 'default_dismiss_policy': 'timed', 'default_auto_dismiss_ms': 8000, 'default_zone': 'top_right', 'supports': {'drag': True, 'resize': True, 'pin': True, 'auto_dismiss': True}, 'description': 'Dynamic schema-driven composed widget surface'}, 'media_control': {'aliases': ['media', 'media player', 'music', 'music player'], 'implemented': False, 'renderer': 'UnavailableWidget', 'renderer_module': 'frontend/src/scene/widgets/UnavailableWidget.tsx', 'default_dismiss_policy': 'timed', 'default_auto_dismiss_ms': 6000, 'default_zone': 'bottom_right', 'supports': {'drag': True, 'resize': True, 'pin': True, 'auto_dismiss': True}, 'description': 'Media playback and audio volume controller'}, 'file_viewer': {'aliases': ['file'], 'implemented': False, 'renderer': 'UnavailableWidget', 'renderer_module': 'frontend/src/scene/widgets/UnavailableWidget.tsx', 'default_dismiss_policy': 'timed', 'default_auto_dismiss_ms': 5000, 'default_zone': 'top_right', 'supports': {'drag': True, 'resize': True, 'pin': True, 'auto_dismiss': True}, 'description': 'Directory listing and file inspection widget'}}
